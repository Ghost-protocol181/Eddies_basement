const CACHE='eddies-basement-v4';
...
const NETWORK_FIRST=new Set(['index.html','app.js','launch.js','vault-data.js','catalog-fallback.js','previews.js','artwork-data.js','health.json']);
