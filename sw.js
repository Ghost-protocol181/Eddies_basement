const CACHE='eddies-basement-v37';
const CORE=['./','./index.html','./styles.css','./randomizer.css','./launch.css','./polish.css','./command-ui.css','./app-flow.css','./experience.css','./brand-polish.css','./decision-flow.css','./copy-cleanup.js','./app.js','./safety-filter.js','./catalog-vetted-expansion.js','./image-reliability.js','./image-display-guard.js','./library-expansion.js','./filter-view-fixes.js','./launch.js','./vault-data.js','./catalog-fallback.js','./previews.js','./artwork-data.js','./favicon.svg','./social-card.svg','./manifest.webmanifest','./browser-multiplayer-games.html','./no-download-multiplayer-games.html','./free-party-games-online.html','./two-player-online-games.html','./phone-party-games.html','./privacy.html','./terms.html','./contact.html','./feedback.html','./sitemap.xml'];
const NETWORK_FIRST=new Set(['index.html','styles.css','randomizer.css','launch.css','polish.css','command-ui.css','app-flow.css','experience.css','brand-polish.css','decision-flow.css','copy-cleanup.js','app.js','safety-filter.js','catalog-vetted-expansion.js','image-reliability.js','image-display-guard.js','library-expansion.js','filter-view-fixes.js','launch.js','vault-data.js','catalog-fallback.js','previews.js','artwork-data.js','browser-multiplayer-games.html','no-download-multiplayer-games.html','free-party-games-online.html','two-player-online-games.html','phone-party-games.html','sitemap.xml','health.json']);
